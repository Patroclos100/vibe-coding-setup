---
description: Initialize a new product through intake, blueprint selection, and product initialization
...
5. Invoke the agents required for `product-initialization.ai`
...
- command name: /factory-create-product
- purpose: Initialize a new product through intake, blueprint selection, and product initialization
- trigger: explicit operator request or pipeline continuation authorized by policy
- workflow invoked: product-initialization.ai
- agents involved: product-manager-agent, blueprint-designer-agent, factory-orchestrator-agent
- expected artifacts: project portfolio entry, factory state update, module plan seed
