---
description: Prepare release candidate and approval package
...
- command name: /release-prepare
- purpose: Prepare release candidate and approval package
- trigger: explicit operator request or pipeline continuation authorized by policy
- workflow invoked: release.ai
- agents involved: release-manager-agent, qa-supervisor-agent
- expected artifacts: release candidate, approval checklist
