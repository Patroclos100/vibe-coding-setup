---
description: Select and record the best-fit blueprint for the current request
...
5. Invoke the agents required for `blueprint-selection.ai`
...
- command name: /factory-select-blueprint
- purpose: Select and record the best-fit blueprint for the current request
- trigger: explicit operator request or pipeline continuation authorized by policy
- workflow invoked: blueprint-selection.ai
- agents involved: product-manager-agent, blueprint-designer-agent, system-architect-agent
- expected artifacts: blueprint decision, required modules list
