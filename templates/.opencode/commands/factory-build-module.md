---
description: Build or reuse one module under module planning and quality gates
...
5. Invoke the agents required for `small-module-build.ai`
...
- command name: /factory-build-module
- purpose: Build or reuse one module under module planning and quality gates
- trigger: explicit operator request or pipeline continuation authorized by policy
- workflow invoked: small-module-build.ai
- agents involved: module-registry-agent, system-architect-agent, vc-code-generator, qa-supervisor-agent
- expected artifacts: module decision, changed files, test results
